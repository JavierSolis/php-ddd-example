 ...
 */
class getServicesResetterService extends App_KernelTestTestContainer
{
    /*
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        }, fn () => 0 + (int) (isset($container->services['request_stack'])) + (int) (isset($container->privates['container.env_var_processor'])) + (int) (isset($container->services['cache.app'])) + (int) (isset($container->services['cache.system'])) + (int) (isset($container->privates['cache.validator'])) + (int) (isset($container->privates['cache.serializer'])) + (int) (false) + (int) (isset($container->services['cache.validator_expression_language']))), ['request_stack' => ['?resetRequestFormats'], 'container.env_var_processor' => ['reset'], 'cache.app' => ['reset'], 'cache.system' => ['reset'], 'cache.validator' => ['reset'], 'cache.serializer' => ['reset'], 'cache.property_info' => ['reset'], 'cache.validator_expression_language' => ['reset']]);
    }
}
