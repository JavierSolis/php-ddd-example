 ...
 */
class getTest_PrivateServicesLocatorService extends App_KernelTestTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        return $container->services['test.private_services_locator'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Application\\UseCase\\RegisterUser' => ['privates', 'App\\Application\\UseCase\\RegisterUser', 'getRegisterUserService', true],
            'App\\Infrastructure\\Repository\\DoctrineUserRepository' => ['privates', 'App\\Infrastructure\\Repository\\DoctrineUserRepository', 'getDoctrineUserRepositoryService', true],
            'App\\Application\\EventListener\\SendWelcomeEmail' => ['privates', 'App\\Application\\EventListener\\SendWelcomeEmail', 'getSendWelcomeEmailService', true],
            'App\\Infrastructure\\Persistence\\DoctrineEntityManager' => ['privates', 'App\\Infrastructure\\Persistence\\DoctrineEntityManager', 'getDoctrineEntityManagerService', true],
            ...
            'App\\Domain\\Repository\\UserRepositoryInterface' => ['privates', 'App\\Infrastructure\\Repository\\DoctrineUserRepository', 'getDoctrineUserRepositoryService', true],
            'Symfony\\Component\\EventDispatcher\\EventDispatcherInterface' => ['services', 'event_dispatcher', 'getEventDispatcherService', false],
            'Doctrine\\ORM\\EntityManagerInterface' => ['privates', 'App\\Infrastructure\\Persistence\\DoctrineEntityManager', 'getDoctrineEntityManagerService', true],
            ...
            'argument_resolver.controller_locator' => ['privates', '.service_locator..eOkrAb', 'get_ServiceLocator__EOkrAbService', true],
